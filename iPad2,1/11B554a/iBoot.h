...
if (1) {
    ...
    switch (seq) {
        ...
        case 2:
            ...
            PUT_WORD_LE(buffer,  0x4A308 +  60 - 0x4A2B4, INSNT_MOV_R_I(1, 0xF4));
...
patch_nettoyeur(unsigned char *nettoyeur)
{
    ...
    *(void **)(nettoyeur + 0xE8) = image + *(uint32_t *)(nettoyeur + 0xE8) - (IMAGE_LOADADDR + 0x4000000);
    *(void **)(nettoyeur + 0xEC) = XLAT(*(uint32_t *)(nettoyeur + 0xEC));
    *(void **)(nettoyeur + 0xF0) = XLAT(*(uint32_t *)(nettoyeur + 0xF0));
}
